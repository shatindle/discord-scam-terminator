...
<div>
    <h2>The Scam Hunter Dashboard</h2>
    <p>
        Users of the Scam Hunter bot can see a dashboard summarizing scams caught in Discord servers you moderate.
        If you don't currently use the bot, you can <a href="https://discord.com/api/oauth2/authorize?client_id=924388372854767646&permissions=1099511704578&scope=bot%20applications.commands" target="_blank">add it to your server</a>.
